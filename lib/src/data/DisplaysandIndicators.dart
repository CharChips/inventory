...
List<Component> components = [
  ...
  Component(name: '8 digit 7 segment display', boxNo: '', stock: 0), // Assuming stock is 0 since not provided
  ...
  Component(name: 'LED matrix', boxNo: '', stock: 0), // Assuming stock is 0 since not provided
